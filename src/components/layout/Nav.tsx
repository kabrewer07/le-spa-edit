  ...
  return (
    <>
      <style>{`
        ...
        .nav-inner { display: grid; grid-template-columns: 1fr auto; align-items: center; }
        @media (min-width: 768px) { .nav-inner { grid-template-columns: 1fr auto 1fr; } }
      ...
      >
        ...
        <div className="nav-inner px-5 md:px-10 h-[57px] max-w-[1200px] mx-auto w-full">

          {/* Col 1 — Logo */}
          <Link
            href="/"
            aria-label="Le Spa Edit home"
            className="font-display text-[20px] tracking-[0.1em] uppercase no-underline text-[var(--color-ink)]"
          >
                ...
                <li key={href}>
                  <Link
                    ...
                    className={cn(
                      ...
                      'motion-safe:transition-[opacity,color] duration-[250ms] ease',
          ...
          <div className="col-start-3 justify-self-end flex items-center gap-3">
            <button
              ...
              className="w-8 h-8 rounded-full border border-[var(--color-border)] bg-transparent text-[var(--color-ink2)] cursor-pointer flex items-center justify-center motion-safe:transition-colors duration-[250ms] ease hover:bg-[var(--color-teal-pale)] hover:border-[var(--color-teal-lt)]"
            >
            ...
            >
              <span
                className="block w-4 h-[1.5px] bg-[var(--color-ink2)] origin-center motion-safe:transition-[transform,opacity] duration-300 ease"
        ...
        {/* Mobile dropdown */}
        <div className={cn('mobile-dropdown text-center', menuOpen && 'open')}>
            ...
            {NAV_LINKS.map(({ href, label }) => (
              <Link
                ...
                className={cn(
                  ...
                  'no-underline motion-safe:transition-colors duration-[250ms] ease',
                  'hover:text-[var(--color-teal)]',
                  pathname === href ? 'text-[var(--color-teal)]' : 'text-[var(--color-ink2)]',
                )}
              >
                {label}
              </Link>
